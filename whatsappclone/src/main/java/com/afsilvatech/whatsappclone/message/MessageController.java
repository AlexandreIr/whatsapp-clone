...
public class MessageController {
    ...
    @PatchMapping("/chat/{chat-d}")
    @ResponseStatus(HttpStatus.ACCEPTED)
    public void editMessage(@RequestParam("message-id") String messageId, Authentication authentication){
        messageService.editMessage(messageId, authentication);
    }
}
