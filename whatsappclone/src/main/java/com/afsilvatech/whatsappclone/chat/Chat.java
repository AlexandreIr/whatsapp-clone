package com.afsilvatech.whatsappclone.chat;


import com.afsilvatech.whatsappclone.common.BaseAuditingEntity;
import com.afsilvatech.whatsappclone.message.Message;
import com.afsilvatech.whatsappclone.message.MessageState;
import com.afsilvatech.whatsappclone.message.MessageType;
import com.afsilvatech.whatsappclone.user.User;
...
@NamedQuery(name = ChatConstants.CHAT_EXISTS,
            query = "SELECT CASE WHEN COUNT(c) > 0 THEN true ELSE false END FROM Chat c WHERE c.id = :chatId"
)
